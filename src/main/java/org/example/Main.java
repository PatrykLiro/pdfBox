...
public class Main {
    ...
    public static void writeTextColumn(PDPageContentStream content, int tx, int ty, PDFont font, String text, int wrapLenght) {
    ...
    public static void drawImage(PDDocument doc, PDPageContentStream content, int tx, int ty, float scaleX, float scaleY, String fileName) {
        try {
    ...
    public static void main(String[] args) throws Exception {
        ...
        writeLineOfText(content, 40, 100, null, "Hello World!");
        ...
        drawImage(document, content, 40, 250, 0.3f, 0.3f, "files/img1.jpg");
        ...
        writeLineOfText(content2, 40, 700, PDType1Font.COURIER_BOLD, "Hello World!");
        content2.close();
